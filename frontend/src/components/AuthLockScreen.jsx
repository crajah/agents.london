    ...
    <Box sx={{
      ...
      <Container maxWidth="sm">
        ...
        >
          ...
          {/* Real Google and Microsoft OIDC Authentication Buttons */}
          <Stack spacing={1.5}>
            <Button
              variant="contained"
              fullWidth
              size="large"
              onClick={() => triggerGoogleOIDC((authenticatedEmail) => handleLoginSubmit(authenticatedEmail))}
              sx={{
            ...
            <Button
              ...
              fullWidth
              size="large"
              onClick={() => triggerMicrosoftOIDC((authenticatedEmail) => handleLoginSubmit(authenticatedEmail))}
              sx={{
              ...
              startIcon={<svg width="20" height="20" viewBox="0 0 23 23"><path fill="#f35325" d="M1 1h10v10H1z"/><path fill="#81bc06" d="M12 1h10v10H1z"/><path fill="#05a6f0" d="M1 12h10v10H1z"/><path fill="#ffba08" d="M12 12h10v10H12z"/></svg>}
            >
