...
export default function SSOModal({ open, onClose, onLoginSuccess }) {
  ...
  const resolveTenancy = (rawEmail) => {
    if (!rawEmail || !rawEmail.includes('@')) {
      return { userPart: 'chandan', domainPart: 'gmail.com', orgId: 'org_user_chandan_gmail_com', isGeneric: true };
    }
  ...
  const handleApplyLogin = (targetEmail) => {
    onLoginSuccess(targetEmail || email);
    onClose();
  };
  ...
  return (
    <Dialog open={open} onClose={onClose} maxWidth="xs" fullWidth>
      ...
      <DialogContent sx={{ display: 'flex', flexDirection: 'column', gap: 2, pt: 1 }}>
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1.5 }}>
          <Button
            ...
            fullWidth
            onClick={() => {
              const testEmail = prompt("Simulate Google Identity OAuth - Enter Email:", "chandan@gmail.com");
              if (testEmail) handleApplyLogin(testEmail);
            }}
            sx={{
          ...
          <Button
            ...
            fullWidth
            onClick={() => {
              const testEmail = prompt("Simulate Microsoft Identity OAuth - Enter Email:", "chandan@outlook.com");
              if (testEmail) handleApplyLogin(testEmail);
            }}
            sx={{
            ...
            startIcon={<svg width="18" height="18" viewBox="0 0 23 23"><path fill="#f35325" d="M1 1h10v10H1z"/><path fill="#81bc06" d="M12 1h10v10H12z"/><path fill="#05a6f0" d="M1 12h10v10H1z"/><path fill="#ffba08" d="M12 12h10v10H12z"/></svg>}
          >
            Sign in with Microsoft
          </Button>
        </Box>

        <Divider sx={{ my: 1 }}><Typography variant="caption" color="text.secondary">OR TEST WITH ANY EMAIL</Typography></Divider>
      ...
      <DialogActions sx={{ px: 3, pb: 2 }}>
        ...
        <Button onClick={() => handleApplyLogin(email)} variant="contained" color="primary">
